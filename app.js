...
var TUTORIAL_STEPS = [
  ...
  {
    icon: '📍',
    title: '1. Add your destinations',
    body: 'Open the Base List tab and use the Destinations card to add the places you’re going — tap “+ Add destination.” Do this first, so you can tag each item as you add it instead of going back later.',
  ...
  },
  {
    ...
    body: 'Next, tap “+ Add item” under any category to build out your list. Set how much you need — a fixed amount, or a rate per day for things like socks. Long-press a category name to collapse it — tap it again to expand.',
    illustration: function(){
  ...
  },
  {
    ...
    illustration: function(){
      ...
      return el('div', { class: 'item-row tutorial-illustration' }, [
        ...
        el('span', { class: 'item-name', text: 'Sunscreen' })
      ]);
    }
  },
  {
...
function boot(){
  ...
  root.innerHTML =
    '<header class="topbar">' +
      '<div class="brand"><img class="brand-mark" src="logo-mark.png?v=1" alt="Zip It!" /><div><h1>Zip It!</h1><p class="eyebrow">packing, calculated</p></div></div>' +
